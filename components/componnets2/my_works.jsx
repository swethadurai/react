...
import './my_works.css'; // Ensure styles are imported properly
    ...
    <div className="myworks-container">
      {projects.map((project) => (
        <div key={project.id} className="myworks-card">
          <img src={project.imageUrl} alt={project.title} className="myworks-image" />
          <div className="myworks-details">
            <h3>{project.title}</h3>
